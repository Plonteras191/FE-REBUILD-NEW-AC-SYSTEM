...
import { Plus, Trash2, User, Calendar, Settings } from "lucide-react"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Schedule your AC service with our professional team. Fill out the form below and we'll get back to you shortly.
            </p>
            
            {/* Date Availability Info */}
            {isLoadingDates ? (
              <div className="mt-6 p-4 bg-blue-50 rounded-xl border border-blue-200">
                <p className="text-blue-700 font-medium">Loading available dates...</p>
              </div>
            ) : (
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
              <div className="bg-gradient-to-r from-blue-600 to-cyan-600 px-8 py-6">
                <h2 className="text-2xl font-bold text-white text-center">Complete Booking Form</h2>
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    {formData.services.map((service, index) => (
                      <div key={service.id} className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                          ...
                          <div>
                            ...
                            {service.date && isDateAvailable(service.date) && (
                              <p className="text-green-600 text-sm mt-1">This date is available</p>
                            )}
                          </div>
                        </div>
                        ...
                        <div>
                          <div className="flex justify-between items-center mb-4">
                            <h5 className="text-lg font-semibold text-gray-800">AC Units</h5>
                            <button
                              type="button"
                          ...
                          <div className="space-y-3">
                            {service.acTypes.map((acType, acTypeIndex) => (
                              <div key={acType.id} className="bg-white rounded-xl p-4 border border-gray-200">
                    ...
                    <button
                      type="button"
                      onClick={addService}
                      className="w-full py-4 px-6 border-2 border-dashed border-blue-300 text-blue-600 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-colors flex items-center justify-center gap-2 font-medium"
                    >
            ...
            <div className="text-center">
              <button
                ...
                className={`px-12 py-4 rounded-2xl font-bold text-lg shadow-lg transition-all duration-300 ${
                  isSubmitting
